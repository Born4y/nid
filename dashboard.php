...
if(!isset($_SESSION['uid'])){
	...
	if(isset($_POST['submit'])){
		if ($diff > $charge) {
			...
			$url =  $json->data->nameEn ." ". $nid ." ". $dob;
			$path = 'qr_img/';
			$file = $path . uniqid() . ".png";
			$ecc = "L";
			$pixel_size = 5;
			$frame_size = 5;
			$var = QRCode::png($url, $file, $ecc, $pixel_size, $frame_size);
...
<head>
	...
	<link href="https://i.postimg.cc/cCtMwSPY/IMG-20240404-192629-166.jpg" rel="icon">
	<link href="https://i.postimg.cc/cCtMwSPY/IMG-20240404-192629-166.jpg" rel="apple-touch-icon">
...
<body onload="showprint()" style="text-align: center;">
    <?php if($_POST['server'] == "new"){ ?>
		<div class="background">
			...
			<div style="position: absolute; left: 37%; top: 32.5%; width: auto; font-size: 13px; color: rgb(7, 7, 7);">পিতার পরিচয় পত্র নম্বর</div>
			<div id="nid_father" style="position: absolute; left: 55%; top: 32.5%; width: auto; font-size: 14px; color: rgb(7, 7, 7);"><?php echo $json->data->nidFather; ?></div>
			...
			<div class="col-12"> 
				<div class="card" style=" min-width: 646px;"> 
					<div class="card-body info-body mx-auto" style="height: unset"> 
						...
						<div class="row"> 
							<div class="card-body profile-card pt-4 d-flex flex-column align-items-center col-4" style=""> </div> 
