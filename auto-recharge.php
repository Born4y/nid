...
define('BKS_USER', '01985271614');
define('BKS_PASS', 'wr^lPx1$at5');
define('BKS_KEY', '3p5RWS7AHljw0aGklfnicHnRtc');
define('BKS_SEC', 'C6NknbDPH0j7SbShy4auKZuAMsn2KHQKLqwUryhErmUBpY4U1Ebb');
							...
							<ol class="list-group list-group-numbered"> 
								<li class="list-group-item d-flex justify-content-between align-items-start"> 
									...
									<form action="" method="POST"> 
										...
										<button type="submit" class="btn btn-primary rounded-pill">Recharge</button> 
									</form> 
								</li> 
								<li class="list-group-item d-flex justify-content-between align-items-start"> 
									<div class="ms-2 me-auto"> 
